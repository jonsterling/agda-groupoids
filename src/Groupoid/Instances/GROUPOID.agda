...
c : ∀ d ..(ℓᵒ ℓˢᵒ ℓˢʰ : _) → G.𝔊₂,₀ G.Dir.≤ _ _ _
-- obj
...
G.Map.com₂ (G.≅.t.iso-fwd (S.Map._$₁_ (G.cmpˢ (c _ _ _ _) {_}{_}{C}) {g₀ , _} (p , q))) =
  S.cmp (G.homˢ C _)
      ...
      ( S.cmp (G.homˢ C _)
        ( S.cmp (G.homˢ C _)
          ( S.cmp (G.homˢ C _)
            ...
            , S.inv (G.homˢ C _) (G.Map.cmp g₀ _ _) )
          , G.cmpˢ C S.Map.$₁
            ( S.idn (G.homˢ C _) _
            , S.cmp (G.homˢ C _)
              ( G.idn-lhs C _
    ...
    , G.cmpˢ C S.Map.$₁
      ( S.idn (G.homˢ C _) _
      , S.inv (G.homˢ C _) (G.Map.nat₁ (G.≅.t.fwd p) (G.Map.com₁ (G.≅.t.fwd q))) ) )
G.Map.com₂ (G.≅.t.iso-bwd (S.Map._$₁_ (G.cmpˢ (c _ _ _ _) {_}{_}{C}) {_ , _}{g₁ , _} (p , q))) =
  S.cmp (G.homˢ C _)
    ...
    , G.cmpˢ C S.Map.$₁
      ( S.idn (G.homˢ C _) _
      , S.inv (G.homˢ C _) (G.Map.nat₁ (G.≅.t.bwd p) (G.Map.com₁ (G.≅.t.bwd q))) ) )
...
G.Map.nat₁ (G.≅.t.fwd (G.cmp-ass (c _ _ _ _) {_}{_}{_}{D} _ _ _)) _ =
  S.cmp (G.homˢ D _)
    ( S.inv (G.homˢ D _) (G.idn-rhs D _)
    , G.idn-lhs D _ )
