...
C.Π._$₀_ (C.Π._$₀_ (oy A) a) b =
  C.homˢ A (a , b)
S.Π._$₀_ (S.Π._$₀_ (C.Π.-$₁ˢᵐ- (C.Π._$₀_ (oy A) _)) g) f =
  C.cmpˢᵐ A S.Π.$₀ (g , f)
S.Π._$₁_ (S.Π._$₀_ (C.Π.-$₁ˢᵐ- (C.Π._$₀_ (oy A) _)) _) φ =
  C.cmpˢᵐ A S.Π.$₁ (S.idnᵗᵐ (C.G.homˢ A _) _ , φ)
S.TF.com₁ (S.Π._$₁_ (C.Π.-$₁ˢᵐ- (C.Π._$₀_ (oy A) _)) φ) =
  C.cmpˢᵐ A S.Π.$₁ (φ , S.idnᵗᵐ (C.G.homˢ A _) _)
S.TF.com₁ (C.Π.idn (C.Π._$₀_ (oy A) _)) =
  C.idn-lhs A _
S.TF.com₁ (C.Π.cmp (C.Π._$₀_ (oy A) _) _ _) =
  C.cmp-ass A _ _ _
S.Π._$₀_ (C.TF.com₁ (S.Π._$₀_ (C.Π.-$₁ˢᵐ- (oy A)) _)) _ =
  C.cmpˢᵐ A S.Π.$₀ (_ , _)
S.Π._$₁_ (C.TF.com₁ (S.Π._$₀_ (C.Π.-$₁ˢᵐ- (oy A)) _)) φ =
  C.cmpˢᵐ A S.Π.$₁ (φ , S.idnᵗᵐ (C.G.homˢ A _) _)
S.TF.com₁ (C.TF.nat₁ (S.Π._$₀_ (C.Π.-$₁ˢᵐ- (oy A)) _) _) =
  C.cmp-ass A _ _ _
S.TF.com₁ (C.TF.com₂ (S.Π._$₁_ (C.Π.-$₁ˢᵐ- (oy A)) φ)) =
  C.cmpˢᵐ A S.Π.$₁ (S.idnᵗᵐ (C.G.homˢ A _) _ , φ)
S.TF.com₁ (C.TF.com₂ (C.Π.idn (oy A))) =
  S.invᵗᵐ (C.homˢ A _) (C.idn-rhs A _)
S.TF.com₁ (C.TF.com₂ (C.Π.cmp (oy A) _ _)) =
  S.invᵗᵐ (C.homˢ A _) (C.cmp-ass A _ _ _)
